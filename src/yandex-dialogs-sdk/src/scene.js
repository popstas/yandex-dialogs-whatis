...
class Scene extends Alice {
  ...
  isEnterCommand(commandName) {
    ...
    if(this.enterCommand.type === 'array'){
      return this.enterCommand.name.find(name => name.toLowerCase() === commandName.toLowerCase());
    } else {
  ...
  isLeaveCommand(commandName) {
    ...
    if(this.leaveCommand.type === 'array'){
      return this.leaveCommand.name.find(name => name.toLowerCase() === commandName.toLowerCase());
    } else {
